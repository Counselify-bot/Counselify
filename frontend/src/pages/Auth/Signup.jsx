            ...
            <div className="container mx-auto px-6 max-w-xl">
                <div className="bg-white p-12 md:p-16 rounded-[64px] shadow-2xl border border-outline-variant/20 relative group overflow-hidden">
                    ...
                    <div className="text-center mb-10 space-y-4">
                        <span className="text-xs font-bold uppercase tracking-[0.4rem] text-[#0462C3]">Get Started Today</span>
                        <h1 className="text-4xl font-bold text-slate-900 serif-font italic tracking-tighter">Register with Counselify</h1>
                    </div>
                    ...
                    <form onSubmit={handleSignup} className="space-y-6">
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-full pl-16 pr-8 py-5 bg-surface-container-low border border-outline-variant/20 rounded-3xl outline-none focus:border-blue-200 transition-all font-bold"
                                value={formData.name}
